...
<h1 class="text-center">NUEVO ADMINISTRATIVO</h1>
<form  class="formulario" action="Guardar/g_administrativo.php" method="post" >
...
<div class="card-body ">
        ...
        <div><span>Apellido: <input required    autofocus    placeholder="Apellido" class="form-control " type="text" name="Apellido" ></span></div>
        ...
        <span>Rol:</span>
        <select  class="custom-select  mb-4 " name="Rol"  autofocus  value="<?php echo $datos['Rol']; ?>">
           <?php 
           $sql=$miconexion->query("SELECT * FROM `Role` WHERE id_rol = 4");
           while($fila=$sql->fetch_array()){
